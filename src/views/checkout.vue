   ...
   -->
        <button v-if="cartItems.length > 0 && !orderPlaced" @click="showPopup = true" class="place-order-button">Place the order</button>
        <Popup :visible="showPopup" @close="showPopup=false">
            <h2> Order placed </h2>
                <p> Thank you, You will recieve order in 3-4 days.  </p>
        </Popup>
